...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CuPJxCd6.mjs')
  },
  {
    name: "item-id",
    path: "/item/:id()",
    component: () => import('./_id_-BpG84G_j.mjs')
  },
  {
    name: "word-word",
    path: "/word/:word()",
    component: () => import('./_word_-DCpimvWb.mjs')
  },
  {
    name: "words",
    path: "/words",
    component: () => import('./index-B6U1wnGH.mjs')
  },
  {
    name: "levels",
    path: "/levels",
    component: () => import('./index-PtaqghGn.mjs')
  },
  {
    name: "topics",
    path: "/topics",
    component: () => import('./index-C-1lAZhk.mjs')
  },
  {
    name: "module-slug",
    path: "/module/:slug()",
    component: () => import('./_slug_-l_Mm23fQ.mjs')
  },
  {
    name: "modules",
    path: "/modules",
    component: () => import('./index-pqr0rBHZ.mjs')
  },
  {
    name: "topics-slug",
    path: "/topics/:slug()",
    component: () => import('./_slug_-DMVzifh1.mjs')
  },
  {
    name: "words-level",
    path: "/words/:level()",
    component: () => import('./_level_-dngvB5i4.mjs')
  },
  {
    name: "levels-level",
    path: "/levels/:level()",
    component: () => import('./_level_-PmEtFXgO.mjs')
  }
];
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "border-b bg-white shadow-sm py-3" }, _attrs))}><div class="max-w-5xl mx-auto flex justify-between items-center px-4">`);
      ...
      _push(`<span class="text-gray-700">${ssrInterpolate(_ctx.user?.name)}</span></div></div></div></header>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CvZI0jIu.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BdZWBCmF.mjs'));
...
export { _export_sfc as _, __nuxt_component_0 as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry_default as default, fetchDefaults as f, tryUseNuxtApp as t, useRoute as u };
