...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "max-w-3xl mx-auto py-12 px-4" }, _attrs))}><h1 class="text-3xl font-semibold mb-4"> Levels </h1><p class="text-gray-600 mb-8"> Explore Cantonese sentence patterns organised by Level level </p><ul class="space-y-4"><!--[-->`);
...
//# sourceMappingURL=index-PtaqghGn.mjs.map
