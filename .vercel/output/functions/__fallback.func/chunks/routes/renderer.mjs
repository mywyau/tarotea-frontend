...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Learn natural, spoken Cantonese with practical modules and topics."}],"link":[],"style":[],"script":[],"noscript":[],"title":"TaroTea — Learn Spoken Cantonese"};
