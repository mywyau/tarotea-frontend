...
const {
  ...
  () =>
    (isLoggedIn.value ? authedFetch : publicFetch)<SentenceQuizStartResponse>(
      ...
      <template v-else>
        ...
        <transition name="fade-scale" mode="out-in">
          ...
          <div v-else-if="showResults" key="results" class="space-y-6">
            ...
            <transition-group name="card-fade" tag="div" class="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-1">
              <div class="stat-card hover:brightness-110 result-0 min-w-[calc(50%-0.5rem)] snap-start">
                <p class="stat-label">Correct</p>
                <p class="stat-value">{{ score }}</p>
              </div>

              <div class="stat-card hover:brightness-110 result-2 min-w-[calc(50%-0.5rem)] snap-start">
                <p class="stat-label">Incorrect</p>
                <p class="stat-value">{{ incorrectCount }}</p>
              </div>

              <div class="stat-card hover:brightness-110 result-4 min-w-[calc(50%-0.5rem)] snap-start">
              ...
              <div class="stat-card hover:brightness-110 result-3 min-w-[calc(50%-0.5rem)] snap-start">
              ...
              <div class="stat-card hover:brightness-110 result-1 min-w-[calc(50%-0.5rem)] snap-start">
