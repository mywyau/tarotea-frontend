        ...
        <ul class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
            ...
            <li v-for="topic in paginatedTopics" :key="topic.id" class="topic-card" :class="[
                ...
                <div class="grid grid-cols-2 gap-3 pt-4">
                    ...
                    <NuxtLink :to="canEnterTopic(topic) ? `/topic/quiz/vocabulary/word/v5/${topic.id}` : undefined"
                    ...
                    <NuxtLink :to="canEnterTopic(topic) ? `/topic/quiz/sentences/${topic.id}/v3` : undefined"
