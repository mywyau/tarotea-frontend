...
<template>
  <main class="quiz-page mx-auto px-4 py-10 sm:py-14 space-y-8">



    <section class="quiz-layout text-center space-y-5">
      ...
      <div v-else-if="showQuiz" class="quiz-stage">

        <aside class="prompt-panel">
          <p class="prompt-kicker">Choose the best match</p>
        ...
        <div class="answer-panel">
          <div class="answer-grid">
            <button v-for="(option, i) in question.options" :key="i" class="answer-tile rounded-xl flex items-center justify-center
                font-semibold text-center p-5 select-none
...
@media (min-width: 1024px) {
  .quiz-stage {
    grid-template-columns: minmax(20rem, 0.9fr) minmax(26rem, 1fr);
    grid-template-areas:
      "prompt answers"
      "next next";
